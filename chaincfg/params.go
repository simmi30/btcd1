...
var MainNetParams = Params{
	...
	Deployments: [DefinedDeployments]ConsensusDeployment{
		DeploymentTestDummy: {
			BitNumber:  28,
			StartTime:  1655874259, // January 1, 2008 UTC
			ExpireTime: 1684731859, // December 31, 2008 UTC
		},
		DeploymentCSV: {
			BitNumber:  0,
...
var RegressionNetParams = Params{
	...
	// Human-readable part for Bech32 encoded segwit addresses, as defined in
	// BIP 173.
	Bech32HRPSegwit: "rbro", // always bcrt for reg test net
